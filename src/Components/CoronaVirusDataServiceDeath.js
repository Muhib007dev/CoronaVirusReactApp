...
const url = 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_19-covid-Deaths.csv'


class CoronaVirusDataServiceDeath extends Component {
    constructor(props) {
        super(props)
...
export default CoronaVirusDataServiceDeath
